...
run: dist/src/date/internal-date.js
	DEBUG=project* node dist/src/date/internal-date.js

index.ts: $(SOURCES)

dist/src/date/internal-date.js: node_modules/.last_lint node_modules/.bin/tsc coverage/index.html
